...
public class CafeFacadeImpl implements CafeFacade {
    ...
    public CafeFacadeImpl(BeanRepository beanRepository, EmployeeRepository employeeRepository) {
    ...
    public Coffee makeCoffee(Employee employee, String beanName, int coffeeTypeAction, int coffeeSizeAction, int coffeeTemperatureAction) {
        ...
        Coffee madeCoffee = new Coffee.Builder().beanName(beanName).coffeeType(getCoffeeType(coffeeTypeAction)).coffeeSize(getCoffeeSize(coffeeSizeAction)).coffeeTemperature(getCoffeeTemperature(coffeeTemperatureAction)).madeBy(employee.getName()).build();
